...
import { CalendarIcon, MailIcon, MapPinIcon, UserIcon, CakeIcon } from "lucide-react"
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden my-6">
                        ...
                        <div className="relative">
                            <Avatar
                                ...
                                imageProps={{
                                    ...
                                    width: 128,
                                    height: 128,
                                    className: "w-32 h-32 border-4 border-white shadow-md rounded-full" 
                                }}
                            />
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 w-full sm:w-auto sm:max-w-md mx-auto min-[900px]:mx-0! mt-2">
                            ...
                            <div className="flex flex-col justify-center items-center min-[900px]:items-start! p-4 bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100/50 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                                ...
                                <p className="text-xl sm:text-2xl font-bold text-emerald-600">
                                    {positiveRatingPercent !== 0 ? `${positiveRatingPercent}%` : '--'}
                                </p>
                            </div>
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center">
                    <span className="bg-white px-3 text-sm font-medium text-gray-400 uppercase tracking-wider">Thông tin chi tiết</span>
                </div>
            </div>
            ...
            <div className="p-6 sm:p-8 lg:p-10 bg-white">
                ...
                <section className="grid grid-cols-1 min-[900px]:grid-cols-2! gap-6">
                    ...
                    <InfoCard 
                        label="Ngày sinh" 
                        value={user.day_of_birth ? new Date(user.day_of_birth).toLocaleDateString('vi-VN') : 'Chưa cập nhật'} 
...
// --- SUB COMPONENT ---
function InfoCard({ label, value, icon, fullWidth = false }: { label: string, value: string, icon: React.ReactNode, fullWidth?: boolean }) {
    return (
        <div className={`
